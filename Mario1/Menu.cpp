...
{
	sf::Texture texture = loadTexture("assets/image/scoreboard.png");
...
{
	sf::Texture texture = loadTexture("assets/image/help.png");
	drawCenterMenuBackground(window, texture);
}
...
{
	sf::Texture texture = loadTexture("assets/image/choosecharacter.png");
...
{
	sf::Texture texture = loadTexture("assets/image/chooseLevel.png");
	drawMenuBackground(window, texture, 0, 0);
...
{
	sf::Texture texture = loadTexture("assets/image/MainMenu.png");
	drawMenuBackground(window, texture, 0, 0);
...
{
	sf::Texture texture = loadTexture("assets/image/PauseMenu.png");
...
{
	sf::Texture texture = loadTexture("assets/image/Ask_Restart.png");
	drawMenuBackground(window, texture, x, y);
